...
public class BirtViewOilReport2 extends AbstractView {
...
//			
		...
		//FileArchiveReader archiveReader=new FileArchiveReader(fileName)
		//FileArchiveWriter archiveWriter=new FileArchiveWriter(fileName)
