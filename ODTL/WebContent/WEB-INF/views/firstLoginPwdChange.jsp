	...
	<div class="container">
				...
				<ul class="navbar-nav  mr-auto">
					<li><h3>
							<span class="navbar-text"><spring:message
									code="odtl.reportsportal.title"></spring:message></span>
						</h3></li>
				</ul>
			</div>
		</nav>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<spring:message code="odtl.reportsportal.pwdChange.label"></spring:message>
		...
		<form:form action="firstLoginPwdChange" id="firstLoginPwdChangeForm"  modelAttribute="passwordEntity" method="POST" class="form-horizontal">
			...
			<spring:message code="odtl.reportsportal.login.username"
				var="usernameLabel" />
			<spring:message code="odtl.reportsportal.login.password"
				var="passwordLabel" />

			<spring:message code="odtl.reportsportal.login.newPassword"
				var="newPassword" />
			<spring:message code="odtl.reportsportal.login.repeatNewPassword"
