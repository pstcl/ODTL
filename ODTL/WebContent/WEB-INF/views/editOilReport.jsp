...
<script type="text/javascript">
	function saveOrUpdate() {
		...
		document.forms['oilReportForm'].action = 'updateOilReport';
...
<script type="text/javascript">
	function setReportDate() {
		$('body').css('display', 'none');
		document.forms['oilReportForm'].action = 'setEditReportDate';
		document.forms['oilReportForm'].submit();
	}
</script>
</head>
			...
			<sec:authorize access="hasRole('JE')">
				<div class="row">
					<div class="form-actions floatRight">
								...
								<input type="button" id="jeUpdateBtn" onClick="saveOrUpdate()"
									value="Update" class="btn btn-primary btn-sm" /> or <a
